...
let jigSawPuzzle = {};
jigSawPuzzle['imageArray'] = [];
jigSawPuzzle['orderedInitialArray'] = [];
jigSawPuzzle['orderedModifiedArray'] = [];
jigSawPuzzle['matched'] = new Array(widthpieces*heightpieces).fill(false);
jigSawPuzzle['moves'] =  0;
