...
elements[elements.length - 1].style.background = 'pink';

4. Select the middle element `li`
var newLiElement = element[(elements.length-1)/2];

5. Use the element in 4 and using sibling nodes change the background color of first and last `li` to `coral` and `aquamarine`;
newLiElement.previousElementSibling.style.background = 'coral';
newLiElement.previousElementSibling.style.background = 'aquamarine'; 
