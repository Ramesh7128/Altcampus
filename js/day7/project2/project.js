...
text.innerHTML = `I love <strong>Javascript</strong>`
document.body.appendChild(text);

var newul = document.createElement('ul');
newul.innerHTML = "<li>Buy groceries</li><li>Feed the cat</li><li>Do laundry</li>"
document.body.appendChild(newul);

var newli = document.createElement('li');
newli.textContent = 'sleep';
document.getElementsByTagName('ul')[0].appendChild(newli);

document.getElementsByTagName('ul')[0].removeChild(document.getElementsByTagName('ul')[0].childNodes[3]);
